...
import  {FloatingImageWidget} from '../../../../components/FloatingImageWidget'
...
<div align="center" class="click-zoom container transformer_image" style={{ display: "flex", justifyContent: "center" }}>
...
<div class="pe">
    <Image src={pe}  alt="A description of my image." />
</div>
